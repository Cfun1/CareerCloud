...
//,IApiController<CompanyLocationPoco>
{
    ...
    [HttpPost("Location")]
    [MapToApiVersion("1.0")]
    [ProducesResponseType<CompanyLocationPoco>(StatusCodes.Status200OK)]
    [ProducesResponseType<CompanyLocationPoco>(StatusCodes.Status201Created)]
    ...
    /// GET: api/careercloud/CompanyLocation/v1/Location
    [HttpGet("Location")]
    [MapToApiVersion("1.0")]
    [ProducesResponseType<ICollection<CompanyLocationPoco>>(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status503ServiceUnavailable)]
    public ActionResult<ICollection<CompanyLocationPoco>> GetAll()
    {
        try
        {
            if (logic is null)
    ...
    /// GET: api/careercloud/CompanyLocation/v1/Location/Id
    [HttpGet("Location/{id}")]
    [MapToApiVersion("1.0")]
    [ProducesResponseType<CompanyLocationPoco>(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    ...
    /// DELETE: api/careercloud/CompanyLocation/v1/Location
    [HttpDelete("Location")]
    [MapToApiVersion("1.0")]
    ...
    /*
     /// DELETE: api/careercloud/CompanyLocation/v1/Location/Id
    ...
    */
    ...
    /// PUT: api/careercloud/CompanyLocation/v1/Location
    [HttpPut("Location")]
    [MapToApiVersion("1.0")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
